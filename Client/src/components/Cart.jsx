...
const Cart = ({ isOpen, onClose }) => {
    ...
    return (
        <div className={`cart-overlay ${isOpen ? "open" : ""} position-fixed top-0 start-0 w-100 h-100 z-3`}>
            <div className={`cart-sidebar ${isOpen ? "open" : ""} position-fixed top-0 h-100 bg-white shadow-lg d-flex flex-column p-3 oveflow-auto z-3`}>
                ...
                {cartItems.length === 0 ? (
                    ...
                    <>
                        ...
                        <div className='cart-footer py-3 d-flex align-items-center justify-content-between border-top text-center'>
